...
class DBManager(context: Context?) : SQLiteOpenHelper(context, "FoodEmission.db", null, 1) {
    ...
    private fun insertCountryData(db: SQLiteDatabase) {
        ...
        insertCountry(db, "USA",1.2230248 , true)//13
        insertCountry(db, "Indien",2.0416272 , false)//14
        insertCountry(db, "New Zealand",2.3757766 , false)//15
        insertCountry(db, "Brasilien",1.9488758 , false)//16
        insertCountry(db, "Frankrig", 0.2524788, false)//17
        insertCountry(db, "Egypten", 1.3174058, false)//18
        insertCountry(db, "Sydafrika", 1.3174058, false)//19
        insertCountry(db, "Chile", 1.9488758, false)//20
        insertCountry(db, "Colombia", 1.9488758, false)//21
        insertCountry(db, "Israel", 1.3393066, false)//22
        insertCountry(db, "Mexico", 1.9488758, false)//23
        insertCountry(db, "Ecuador", 1.9488758, false)//24
        insertCountry(db, "Argentina", 1.9488758, false)//25
        insertCountry(db, "Belgien", 0.1616088, true)//26
        insertCountry(db, "Portugal", 0.02796, false)//27
        insertCountry(db, "Mozambique", 1.3174058, false)//28
        insertCountry(db, "Kenya", 1.3174058, false)//29
        insertCountry(db, "Senegal", 1.3174058, false)//30
        insertCountry(db, "Costa Rica", 1.9488758, false)//31
        insertCountry(db, "Vietnam", 2.3757766, false)//32
        insertCountry(db, "Den Dominikanske Republik", 1.9488758, false)//33
        insertCountry(db, "Østrig", 0.21669, true)//34
        insertCountry(db, "Namibia", 1.3174058, false)//35
        insertCountry(db, "Guatemala", 1.9488758, false)//36
        insertCountry(db, "Zimbabwe", 1.3174058, false)//37
        insertCountry(db, "Bulgarien", 0.0849031172, false)//38
    }
    ...
    private fun insertProductData(db: SQLiteDatabase) {
        insertProduct(db, "Agurk", ProductCategory.VEGETABLES, 0.05, 0.01, 0.00, 0.14, 0.01, true,4,500.0)
        insertProduct(db, "Ananas", ProductCategory.VEGETABLES, 0.09, 0.02, 0.00, 0.00, 0.01, true,7,1200.0)
        insertProduct(db, "And", ProductCategory.POULTRY, 1.60, 0.43, 0.00, 0.14, 0.00, false,4,300.0)
        insertProduct(db, "Appelsin", ProductCategory.VEGETABLES, 0.10, 0.02, 0.00, 0.06, 0.01, true,3,160.0)
        insertProduct(db, "Artiskok", ProductCategory.VEGETABLES, 0.27, 0.05, 0.00, 0.06, 0.01, false,1,150.0)
        insertProduct(db, "Asparges", ProductCategory.VEGETABLES, 0.27, 0.10, 0.00, 0.06, 0.01, false,3,500.0)
        insertProduct(db, "Aubergine", ProductCategory.VEGETABLES, 0.16, 0.02, 0.00, 0.14, 0.01, true,8,250.0)
        insertProduct(db, "Avocado", ProductCategory.VEGETABLES, 0.32, 0.06, 0.00, 0.14, 0.01, true,9,150.0)
        insertProduct(db, "Banan", ProductCategory.VEGETABLES, 0.21, 0.02, 0.00, 0.14, 0.01, true,7,110.0)
        insertProduct(db, "Basilikum", ProductCategory.VEGETABLES, 0.13, 0.03, 0.00, 0.06, 0.01, false,4,100.0)
        insertProduct(db, "Bladselleri", ProductCategory.VEGETABLES, 0.13, 0.03, 0.00, 0.06, 0.01, false,4,300.0)
        insertProduct(db, "Blomkål", ProductCategory.VEGETABLES, 0.15, 0.04, 0.00, 0.06, 0.01, false,3,450.0)
        insertProduct(db, "Blomme", ProductCategory.VEGETABLES, 0.27, 0.10, 0.00, 0.14, 0.01, false,4,500.0)
        insertProduct(db, "Blåbær", ProductCategory.VEGETABLES, 1.76, 0.94, 0.00, 0.14, 0.01, false,9,125.0)
        insertProduct(db, "Broccoli", ProductCategory.VEGETABLES, 0.15, 0.04, 0.00, 0.06, 0.01, false,3,350.0)
        insertProduct(db, "Brombær", ProductCategory.VEGETABLES, 0.31, 0.14, 0.00, 0.14, 0.01, false,2,125.0)
        insertProduct(db, "Bønnespirer", ProductCategory.VEGETABLES, 0.20, 0.04, 0.00, 0.14, 0.01, true,8,150.0)
        insertProduct(db, "Champignon", ProductCategory.VEGETABLES, 0.01, 0.01, 0.00, 0.26, 0.00, false,10,500.0)
        insertProduct(db, "Citron", ProductCategory.VEGETABLES, 0.09, 0.03, 0.00, 0.14, 0.01, true,3,85.0)
        insertProduct(db, "Dild", ProductCategory.VEGETABLES, 0.13, 0.03, 0.00, 0.14, 0.01, false,4,20.0)
        insertProduct(db, "Fennikel", ProductCategory.VEGETABLES, 3.30, 0.95, 0.00, 0.14, 0.01, false,4,200.0)
        insertProduct(db, "Fersken", ProductCategory.VEGETABLES, 0.11, 0.03, 0.00, 0.14, 0.01, false,1,100.0)
        insertProduct(db, "Forårsløg", ProductCategory.VEGETABLES, 0.18, 0.04, 0.00, 0.06, 0.01, false,11,200.0)
        insertProduct(db, "Grapefrugt", ProductCategory.VEGETABLES, 0.09, 0.02, 0.00, 0.14, 0.01, true,8,350.0)
        insertProduct(db, "Grisefilet", ProductCategory.PORK, 3.33, 0.58, -0.26, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Grisekød, hakket", ProductCategory.PORK, 2.50, 0.39, -0.25, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Grisekød, nakkefilet", ProductCategory.PORK, 3.22, 0.50, -0.41, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Grisekød, nakkekam med svær", ProductCategory.PORK, 2.78, 0.48, -0.22, 0.14, 0.00, false,4,2400.0)
        insertProduct(db, "Grisekød, svinekam med svær", ProductCategory.PORK, 2.78, 0.48, -0.22, 0.14, 0.00, false,4,2400.0)
        insertProduct(db, "Svinemørbrad", ProductCategory.PORK, 4.45, 0.77, -0.35, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Græskar", ProductCategory.VEGETABLES, 0.14, 0.04, 0.00, 0.06, 0.01, false,8,1000.0)
        insertProduct(db, "Grønkål", ProductCategory.VEGETABLES, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,250.0)
        insertProduct(db, "Grønne bønner", ProductCategory.GRAINLEGUME, 0.20, 0.04, 0.00, 0.14, 0.01, true,8,250.0)
        insertProduct(db, "Linser, tørrede", ProductCategory.GRAINLEGUME, 0.85, 0.33, 0.00, 0.20, 0.01, false,12,400.0)
        insertProduct(db, "Grøntsagsbøffer", ProductCategory.GRAINLEGUME, 0.34, 0.10, 0.33, 0.24, 0.03, false,4,226.0)
        ...
        insertProduct(db, "Hvidløg", ProductCategory.VEGETABLES, 0.51, 0.05, 0.00, 0.06, 0.01, false,3,180.0)
        insertProduct(db, "Hyben", ProductCategory.VEGETABLES, 0.19, 0.03, 0.00, 0.14, 0.01, false,12,250.0)
        insertProduct(db, "Hyldebær", ProductCategory.VEGETABLES, 0.31, 0.14, 0.00, 0.14, 0.01, false,2,250.0)
        insertProduct(db, "Høne", ProductCategory.POULTRY, 1.60, 0.43, -0.06, 0.14, 0.00, false,4,1000.0)
        insertProduct(db, "Ingefær, rod", ProductCategory.VEGETABLES, 0.97, 0.05, 0.00, 0.14, 0.01, true,8,200.0)
        insertProduct(db, "Jordbær", ProductCategory.VEGETABLES, 0.15, 0.06, 0.00, 0.14, 0.01, false,4,400.0)
        insertProduct(db, "Kalkun", ProductCategory.POULTRY, 2.40, 0.61, -0.11, 0.14, 0.00, false,4,800.0)
        insertProduct(db, "Kalkunkød, hakket", ProductCategory.POULTRY, 2.24, 0.60, 0.26, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Kalv og flæsk, hakket", ProductCategory.BEEF, 12.88, 2.47, -0.35, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Kalvekød", ProductCategory.BEEF, 43.77, 8.48, -2.66, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Karse", ProductCategory.VEGETABLES, 0.13, 0.03, 0.00, 0.14, 0.01, false,4,100.0)
        insertProduct(db, "Kartoffel", ProductCategory.VEGETABLES, 0.20, 0.02, 0.00, 0.06, 0.01, false,4,1000.0)
        insertProduct(db, "Kidney bønner", ProductCategory.GRAINLEGUME, 0.14, 0.05, 0.47, 0.22, 0.01, false,8,400.0)
        insertProduct(db, "Kikærter, tørrede", ProductCategory.GRAINLEGUME, 0.93, 0.52, 0.00, 0.20, 0.01, false,15,400.0)
        insertProduct(db, "Kirsebær", ProductCategory.VEGETABLES, 0.26, 0.07, 0.00, 0.14, 0.01, false,12,500.0)
        insertProduct(db, "Kiwi", ProductCategory.VEGETABLES, 0.16, 0.03, 0.00, 0.14, 0.01, true,1,500.0)
        insertProduct(db, "Kylling, ben", ProductCategory.POULTRY, 0.93, 0.25, -0.03, 0.14, 0.00, false,4,800.0)
        insertProduct(db, "Kylling, bryst", ProductCategory.POULTRY, 2.59, 0.69, -0.09, 0.14, 0.00, false,4,450.0)
        insertProduct(db, "Kylling, hel", ProductCategory.POULTRY, 1.60, 0.43, -0.06, 0.14, 0.00, false,4,1350.0)
        insertProduct(db, "Kylling, lår", ProductCategory.POULTRY, 0.88, 0.24, -0.03, 0.14, 0.00, false,4,700.0)
        insertProduct(db, "Lammekølle", ProductCategory.LAMB, 25.35, 6.58, -5.12, 0.14, 0.00, false,15,1300.0)
        insertProduct(db, "Lammekød", ProductCategory.LAMB, 25.35, 6.58, -5.12, 0.14, 0.00, false,15,500.0)
        insertProduct(db, "Lime", ProductCategory.VEGETABLES, 0.09, 0.03, 0.00, 0.06, 0.01, false,3,200.0)
        insertProduct(db, "Løg", ProductCategory.VEGETABLES, 0.18, 0.04, 0.00, 0.06, 0.01, false,11,1000.0)
        insertProduct(db, "Majroe", ProductCategory.VEGETABLES, 0.11, 0.02, 0.00, 0.06, 0.01, false,4,1000.0)
        insertProduct(db, "Majskolbe", ProductCategory.VEGETABLES, 0.21, 0.07, 0.00, 0.14, 0.01, false,4,400.0)
        insertProduct(db, "Mandarin", ProductCategory.VEGETABLES, 0.08, 0.02, 0.00, 0.14, 0.01, true,3,300.0)
        insertProduct(db, "Mango", ProductCategory.VEGETABLES, 0.18, 0.06, 0.00, 0.14, 0.01, true,14,300.0)
        insertProduct(db, "Medisterpølse", ProductCategory.PORK, 1.57, 0.27, 0.13, 0.14, 0.00, false,4,500.0)
        insertProduct(db, "Nektarin", ProductCategory.VEGETABLES, 0.11, 0.03, 0.00, 0.14, 0.01, false,1,115.0)
        insertProduct(db, "Okseculotte", ProductCategory.BEEF, 39.65, 7.68, -2.41, 0.14, 0.00, false,4,450.0)
        insertProduct(db, "Oksekød, hakket", ProductCategory.BEEF, 28.58, 5.46, -1.78, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Okseinderlår", ProductCategory.BEEF, 39.65, 7.68, -2.41, 0.14, 0.00, false,4,1000.0)
        insertProduct(db, "Oksemørbrad", ProductCategory.BEEF, 133.45, 25.85, -8.11, 0.14, 0.00, false,4,1500.0)
        insertProduct(db, "Oksetyndsteg", ProductCategory.BEEF, 70.72, 13.70, -4.30, 0.14, 0.00, false,4,2000.0)
        insertProduct(db, "Chili", ProductCategory.VEGETABLES, 0.25, 0.03, 0.00, 0.14, 0.01, true,8,70.0)
        insertProduct(db, "Peberfrugt", ProductCategory.VEGETABLES, 0.25, 0.03, 0.00, 0.14, 0.01, true,3,400.0)
        insertProduct(db, "Persille", ProductCategory.VEGETABLES, 0.13, 0.03, 0.00, 0.14, 0.01, false,4,50.0)
        insertProduct(db, "Persillerod", ProductCategory.VEGETABLES, 0.23, 0.07, 0.00, 0.06, 0.01, false,4,500.0)
        insertProduct(db, "Porre", ProductCategory.VEGETABLES, 0.16, 0.04, 0.00, 0.06, 0.01, false,4,150.0)
        insertProduct(db, "Portobello", ProductCategory.VEGETABLES, 0.01, 0.01, 0.00, 0.14, 0.01, false,10,250.0)
        insertProduct(db, "Purløg", ProductCategory.VEGETABLES, 0.16, 0.04, 0.00, 0.06, 0.01, false,4,100.0)
        insertProduct(db, "Pære", ProductCategory.VEGETABLES, 0.15, 0.03, 0.00, 0.14, 0.01, false,4,150.0)
        insertProduct(db, "Quinoa", ProductCategory.GRAINLEGUME, 1.04, 0.63, 0.00, 0.20, 0.01, false,9,300.0)
        insertProduct(db, "Rabarber", ProductCategory.VEGETABLES, 0.13, 0.03, 0.00, 0.06, 0.01, false,4,100.0)
        insertProduct(db, "Radise", ProductCategory.VEGETABLES, 0.13, 0.03, 0.00, 0.14, 0.01, false,4,250.0)
        insertProduct(db, "Ribs", ProductCategory.VEGETABLES, 0.25, 0.08, 0.00, 0.14, 0.01, false,4,125.0)
        insertProduct(db, "Rosenkål", ProductCategory.VEGETABLES, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,350.0)
        insertProduct(db, "Rødbede", ProductCategory.VEGETABLES, 0.17, 0.01, 0.00, 0.06, 0.01, false,4,1000.0)
        insertProduct(db, "Rødkål", ProductCategory.VEGETABLES, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,100.0)
        insertProduct(db, "Icebergsalat", ProductCategory.VEGETABLES, 0.08, 0.02, 0.00, 0.06, 0.01, false,3,400.0)
        insertProduct(db, "Savoykål", ProductCategory.VEGETABLES, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,800.0)
        insertProduct(db, "Knoldselleri", ProductCategory.VEGETABLES, 0.13, 0.03, 0.00, 0.06, 0.01, false,4,800.0)
        insertProduct(db, "Skinkeschnitzel", ProductCategory.PORK, 2.78, 0.48, -0.22, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Sojabønner, tørrede", ProductCategory.GRAINLEGUME, 0.32, 0.27, 0.00, 0.20, 0.01, false,8,1000.0)
        insertProduct(db, "Solbær", ProductCategory.VEGETABLES, 0.25, 0.08, 0.00, 0.14, 0.01, false,4,150.0)
        insertProduct(db, "Sorte bønner", ProductCategory.GRAINLEGUME, 0.14, 0.05, 0.47, 0.22, 0.01, false,8,250.0)
        insertProduct(db, "Spidskål", ProductCategory.VEGETABLES, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,700.0)
        insertProduct(db, "Spinat", ProductCategory.VEGETABLES, 0.12, 0.03, 0.00, 0.06, 0.01, false,4,200.0)
        insertProduct(db, "Squash", ProductCategory.VEGETABLES, 0.14, 0.04, 0.00, 0.06, 0.01, true,8,280.0)
        insertProduct(db, "Stikkelsbær", ProductCategory.VEGETABLES, 0.21, 0.09, 0.00, 0.14, 0.01, false,10,250.0)
        insertProduct(db, "Tofu", ProductCategory.GRAINLEGUME, 0.18, 0.11, 0.91, 0.26, 0.00, false, 38, 200.0)
        insertProduct(db, "Tomat", ProductCategory.VEGETABLES, 0.07, 0.01, 0.00, 0.14, 0.01, true,3,500.0)
        insertProduct(db, "Tranebær", ProductCategory.VEGETABLES, 0.15, 0.03, 0.00, 0.14, 0.01, false,14,250.0)
        insertProduct(db, "Vandmelon", ProductCategory.VEGETABLES, 0.03, 0.01, 0.00, 0.00, 0.01, false,3,700.0)
        insertProduct(db, "Vegansk fars", ProductCategory.GRAINLEGUME, 0.15, 0.15, 0.09, 0.14, 0.00, false,4,350.0)
        insertProduct(db, "Vindrue", ProductCategory.VEGETABLES, 0.22, 0.05, 0.00, 0.14, 0.01, true,1,500.0)
        insertProduct(db, "Æble", ProductCategory.VEGETABLES, 0.18, 0.02, 0.00, 0.14, 0.01, false,4,150.0)
        insertProduct(db, "Ærter", ProductCategory.VEGETABLES, 0.36, 0.12, 0.00, 0.06, 0.01, false,4,400.0)
    }

    private  fun insertProduct(db: SQLiteDatabase, name: String, productCategory: ProductCategory, cultivation: Double, iluc: Double, processing: Double, packaging: Double, retail: Double, GHCultivated: Boolean, countryID: Int, weight: Double ): Long {
        val contentValues = ContentValues()
...
// Ærter
    ...
    fun delete(table: String, idName: String, id: String): Int {
        return writableDatabase.delete(table, "$idName = ?", arrayOf(id))
    }
