...
class DBManager(context: Context?) : SQLiteOpenHelper(context, "FoodEmission.db", null, 1) {
    ...
    private fun insertProductData(db: SQLiteDatabase) {
        insertProduct(db, "Agurk", PRODUCT_CATEGORY.NONE, 0.05, 0.01, 0.00, 0.14, 0.01, true,4,500.0)
        insertProduct(db, "Ananas", PRODUCT_CATEGORY.NONE, 0.09, 0.02, 0.00, 0.00, 0.01, true,7,1200.0)
        insertProduct(db, "And", PRODUCT_CATEGORY.POULTRY, 1.60, 0.43, 0.00, 0.14, 0.00, false,4,300.0)
        insertProduct(db, "Appelsin", PRODUCT_CATEGORY.NONE, 0.10, 0.02, 0.00, 0.06, 0.01, true,3,160.0)
        insertProduct(db, "Artiskok", PRODUCT_CATEGORY.NONE, 0.27, 0.05, 0.00, 0.06, 0.01, false,1,150.0)
        insertProduct(db, "Asparges, grønne", PRODUCT_CATEGORY.NONE, 0.27, 0.10, 0.00, 0.06, 0.01, false,3,500.0)
        insertProduct(db, "Aubergine", PRODUCT_CATEGORY.NONE, 0.16, 0.02, 0.00, 0.14, 0.01, true,8,250.0)
        insertProduct(db, "Avocado", PRODUCT_CATEGORY.NONE, 0.32, 0.06, 0.00, 0.14, 0.01, true,9,150.0)
        insertProduct(db, "Banan", PRODUCT_CATEGORY.NONE, 0.21, 0.02, 0.00, 0.14, 0.01, true,7,110.0)
        insertProduct(db, "Basilikum", PRODUCT_CATEGORY.NONE, 0.13, 0.03, 0.00, 0.06, 0.01, false,4,100.0)
        insertProduct(db, "Bladselleri", PRODUCT_CATEGORY.NONE, 0.13, 0.03, 0.00, 0.06, 0.01, false,4,300.0)
        insertProduct(db, "Blomkål", PRODUCT_CATEGORY.NONE, 0.15, 0.04, 0.00, 0.06, 0.01, false,3,450.0)
        insertProduct(db, "Blomme", PRODUCT_CATEGORY.NONE, 0.27, 0.10, 0.00, 0.14, 0.01, false,4,500.0)
        insertProduct(db, "Blåbær", PRODUCT_CATEGORY.NONE, 1.76, 0.94, 0.00, 0.14, 0.01, false,9,125.0)
        insertProduct(db, "Broccoli", PRODUCT_CATEGORY.NONE, 0.15, 0.04, 0.00, 0.06, 0.01, false,3,350.0)
        insertProduct(db, "Brombær", PRODUCT_CATEGORY.NONE, 0.31, 0.14, 0.00, 0.14, 0.01, false,2,125.0)
        insertProduct(db, "Bønnespirer", PRODUCT_CATEGORY.NONE, 0.20, 0.04, 0.00, 0.14, 0.01, true,8,150.0)
        insertProduct(db, "Champignon", PRODUCT_CATEGORY.NONE, 0.01, 0.01, 0.00, 0.26, 0.00, false,10,500.0)
        insertProduct(db, "Citron", PRODUCT_CATEGORY.NONE, 0.09, 0.03, 0.00, 0.14, 0.01, true,3,85.0)
        insertProduct(db, "Dild", PRODUCT_CATEGORY.NONE, 0.13, 0.03, 0.00, 0.14, 0.01, false,4,20.0)
        insertProduct(db, "Fennikel", PRODUCT_CATEGORY.NONE, 3.30, 0.95, 0.00, 0.14, 0.01, false,4,200.0)
        insertProduct(db, "Fersken", PRODUCT_CATEGORY.NONE, 0.11, 0.03, 0.00, 0.14, 0.01, false,1,100.0)
        insertProduct(db, "Forårsløg", PRODUCT_CATEGORY.NONE, 0.18, 0.04, 0.00, 0.06, 0.01, false,11,200.0)
        insertProduct(db, "Grapefrugt", PRODUCT_CATEGORY.NONE, 0.09, 0.02, 0.00, 0.14, 0.01, true,8,350.0)
        ...
        insertProduct(db, "Græskar", PRODUCT_CATEGORY.NONE, 0.14, 0.04, 0.00, 0.06, 0.01, false,8,1000.0)
        insertProduct(db, "Grønkål", PRODUCT_CATEGORY.NONE, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,250.0)
        insertProduct(db, "Grønne bønner", PRODUCT_CATEGORY.NONE, 0.20, 0.04, 0.00, 0.14, 0.01, true,8,250.0)
        insertProduct(db, "Grønne linser", PRODUCT_CATEGORY.VEGAN, 0.85, 0.33, 0.00, 0.20, 0.01, false,12,400.0)
        insertProduct(db, "Grøntsagsbøffer", PRODUCT_CATEGORY.NONE, 0.34, 0.10, 0.33, 0.24, 0.03, false,4,226.0)
        insertProduct(db, "Gulerod", PRODUCT_CATEGORY.NONE, 0.11, 0.02, 0.00, 0.06, 0.01, false,4,1000.0)
        ...
        insertProduct(db, "Hindbær", PRODUCT_CATEGORY.NONE, 0.27, 0.11, 0.00, 0.14, 0.01, false,2,250.0)
        insertProduct(db, "Honningmelon", PRODUCT_CATEGORY.NONE, 0.10, 0.02, 0.00, 0.00, 0.01,false,17,800.0)
        insertProduct(db, "Hvidkål", PRODUCT_CATEGORY.NONE, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,1000.0)
        insertProduct(db, "Hvidløg", PRODUCT_CATEGORY.NONE, 0.51, 0.05, 0.00, 0.06, 0.01, false,3,180.0)
        insertProduct(db, "Hyben", PRODUCT_CATEGORY.NONE, 0.19, 0.03, 0.00, 0.14, 0.01, false,12,250.0)
        insertProduct(db, "Hyldebær", PRODUCT_CATEGORY.NONE, 0.31, 0.14, 0.00, 0.14, 0.01, false,2,250.0)
        insertProduct(db, "Høne", PRODUCT_CATEGORY.POULTRY, 1.60, 0.43, -0.06, 0.14, 0.00, false,4,1000.0)
        insertProduct(db, "Ingefær, rod", PRODUCT_CATEGORY.NONE, 0.97, 0.05, 0.00, 0.14, 0.01, true,8,200.0)
        insertProduct(db, "Jordbær", PRODUCT_CATEGORY.NONE, 0.15, 0.06, 0.00, 0.14, 0.01, false,4,400.0)
        ...
        insertProduct(db, "Karse", PRODUCT_CATEGORY.NONE, 0.13, 0.03, 0.00, 0.14, 0.01, false,4,100.0)
        insertProduct(db, "Kartoffel", PRODUCT_CATEGORY.NONE, 0.20, 0.02, 0.00, 0.06, 0.01, false,4,1000.0)
        insertProduct(db, "Kidney bønner", PRODUCT_CATEGORY.VEGAN, 0.14, 0.05, 0.47, 0.22, 0.01, false,8,400.0)
        insertProduct(db, "Kikærter, tørrede", PRODUCT_CATEGORY.VEGAN, 0.93, 0.52, 0.00, 0.20, 0.01, false,15,400.0)
        insertProduct(db, "Kirsebær", PRODUCT_CATEGORY.NONE, 0.26, 0.07, 0.00, 0.14, 0.01, false,12,500.0)
        insertProduct(db, "Kiwi", PRODUCT_CATEGORY.NONE, 0.16, 0.03, 0.00, 0.14, 0.01, true,1,500.0)
        ...
        insertProduct(db, "Lime", PRODUCT_CATEGORY.NONE, 0.09, 0.03, 0.00, 0.06, 0.01, false,3,200.0)
        insertProduct(db, "Løg", PRODUCT_CATEGORY.NONE, 0.18, 0.04, 0.00, 0.06, 0.01, false,11,1000.0)
        insertProduct(db, "Majroe", PRODUCT_CATEGORY.NONE, 0.11, 0.02, 0.00, 0.06, 0.01, false,4,1000.0)
        insertProduct(db, "Majskolbe", PRODUCT_CATEGORY.NONE, 0.21, 0.07, 0.00, 0.14, 0.01, false,4,400.0)
        insertProduct(db, "Mandarin", PRODUCT_CATEGORY.NONE, 0.08, 0.02, 0.00, 0.14, 0.01, true,3,300.0)
        insertProduct(db, "Mango", PRODUCT_CATEGORY.NONE, 0.18, 0.06, 0.00, 0.14, 0.01, true,15,300.0)
        insertProduct(db, "Medisterpølse", PRODUCT_CATEGORY.PORK, 1.57, 0.27, 0.13, 0.14, 0.00, false,4,500.0)
        insertProduct(db, "Nektarin", PRODUCT_CATEGORY.NONE, 0.11, 0.03, 0.00, 0.14, 0.01, false,1,115.0)
        ...
        insertProduct(db, "Chili", PRODUCT_CATEGORY.NONE, 0.25, 0.03, 0.00, 0.14, 0.01, true,8,70.0)
        insertProduct(db, "Peberfrugt", PRODUCT_CATEGORY.NONE, 0.25, 0.03, 0.00, 0.14, 0.01, true,3,400.0)
        insertProduct(db, "Persille", PRODUCT_CATEGORY.NONE, 0.13, 0.03, 0.00, 0.14, 0.01, false,4,50.0)
        insertProduct(db, "Persillerod", PRODUCT_CATEGORY.NONE, 0.23, 0.07, 0.00, 0.06, 0.01, false,4,500.0)
        insertProduct(db, "Porre", PRODUCT_CATEGORY.NONE, 0.16, 0.04, 0.00, 0.06, 0.01, false,4,150.0)
        insertProduct(db, "Portobello", PRODUCT_CATEGORY.NONE, 0.01, 0.01, 0.00, 0.14, 0.01, false,10,250.0)
        insertProduct(db, "Purløg", PRODUCT_CATEGORY.NONE, 0.16, 0.04, 0.00, 0.06, 0.01, false,4,100.0)
        insertProduct(db, "Pære", PRODUCT_CATEGORY.NONE, 0.15, 0.03, 0.00, 0.14, 0.01, false,4,150.0)
        insertProduct(db, "Quinoa, sort", PRODUCT_CATEGORY.VEGAN, 1.04, 0.63, 0.00, 0.20, 0.01, false,9,300.0)
        insertProduct(db, "Rabarber", PRODUCT_CATEGORY.NONE, 0.13, 0.03, 0.00, 0.06, 0.01, false,4,100.0)
        insertProduct(db, "Radise", PRODUCT_CATEGORY.NONE, 0.13, 0.03, 0.00, 0.14, 0.01, false,4,250.0)
        insertProduct(db, "Ribs", PRODUCT_CATEGORY.NONE, 0.25, 0.08, 0.00, 0.14, 0.01, false,4,125.0)
        insertProduct(db, "Rosenkål", PRODUCT_CATEGORY.NONE, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,350.0)
        insertProduct(db, "Rødbede", PRODUCT_CATEGORY.NONE, 0.17, 0.01, 0.00, 0.06, 0.01, false,4,1000.0)
        insertProduct(db, "Røde linser", PRODUCT_CATEGORY.VEGAN, 0.85, 0.33, 0.00, 0.20, 0.01, false,12,400.0)
        insertProduct(db, "Rødkål", PRODUCT_CATEGORY.NONE, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,100.0)
        insertProduct(db, "Icebergsalat", PRODUCT_CATEGORY.NONE, 0.08, 0.02, 0.00, 0.06, 0.01, false,3,400.0)
        insertProduct(db, "Savoykål", PRODUCT_CATEGORY.NONE, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,800.0)
        insertProduct(db, "Knoldselleri", PRODUCT_CATEGORY.NONE, 0.13, 0.03, 0.00, 0.06, 0.01, false,4,800.0)
        insertProduct(db, "Skinkeschnitzel", PRODUCT_CATEGORY.PORK, 2.78, 0.48, -0.22, 0.14, 0.00, false,4,400.0)
        insertProduct(db, "Sojabønner, tørrede", PRODUCT_CATEGORY.VEGAN, 0.32, 0.27, 0.00, 0.20, 0.01, false,8,1000.0)
        insertProduct(db, "Solbær", PRODUCT_CATEGORY.NONE, 0.25, 0.08, 0.00, 0.14, 0.01, false,4,150.0)
        insertProduct(db, "Sorte bønner", PRODUCT_CATEGORY.NONE, 0.14, 0.05, 0.47, 0.22, 0.01, false,8,250.0)
        insertProduct(db, "Spidskål", PRODUCT_CATEGORY.NONE, 0.10, 0.02, 0.00, 0.06, 0.01, false,4,700.0)
        insertProduct(db, "Spinat", PRODUCT_CATEGORY.NONE, 0.12, 0.03, 0.00, 0.06, 0.01, false,4,200.0)
        insertProduct(db, "Squash", PRODUCT_CATEGORY.NONE, 0.14, 0.04, 0.00, 0.06, 0.01, true,8,280.0)
        insertProduct(db, "Stikkelsbær", PRODUCT_CATEGORY.NONE, 0.21, 0.09, 0.00, 0.14, 0.01, false,10,250.0)
        insertProduct(db, "Tomat", PRODUCT_CATEGORY.NONE, 0.07, 0.01, 0.00, 0.14, 0.01, true,3,500.0)
        insertProduct(db, "Tranebær", PRODUCT_CATEGORY.NONE, 0.15, 0.03, 0.00, 0.14, 0.01, false,14,250.0)
        insertProduct(db, "Vandmelon", PRODUCT_CATEGORY.NONE, 0.03, 0.01, 0.00, 0.00, 0.01, false,3,700.0)
        insertProduct(db, "Vegansk fars", PRODUCT_CATEGORY.VEGAN, 0.15, 0.15, 0.09, 0.14, 0.00, false,4,350.0)
        insertProduct(db, "Vindrue", PRODUCT_CATEGORY.NONE, 0.22, 0.05, 0.00, 0.14, 0.01, true,1,500.0)
        insertProduct(db, "Æble", PRODUCT_CATEGORY.NONE, 0.18, 0.02, 0.00, 0.14, 0.01, false,4,150.0)
        insertProduct(db, "Ærter", PRODUCT_CATEGORY.NONE, 0.36, 0.12, 0.00, 0.06, 0.01, false,4,400.0)
    }
